...
export default function AppLogo({
	...
	return (
		<div className={cn('group flex items-center gap-3', className)}>
			<div
				className={cn(
					'relative flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-br from-primary to-primary/80 shadow-lg transition-all duration-300 group-hover:scale-105 group-hover:shadow-xl group-hover:shadow-primary/25',
					iconClassName,
				)}
			>
				<div className="absolute inset-0 rounded-2xl bg-white/10 opacity-0 transition-opacity duration-300 group-hover:opacity-100" />
				<AppLogoIcon className="z-10 size-5 fill-white drop-shadow-sm transition-transform duration-500 group-hover:rotate-12" />
			</div>
